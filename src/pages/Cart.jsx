...
import { decreaseItemQuantity, getCartTotal, increaseItemQuantity, removeItem } from "../redux/reducers/CartSlice";

const Cart = () => {
  const { cart, cartProduct, totalQuantity, totalPrice } = useSelector((state) => state?.carts);
    ...
    <Layout title={"Cart"}>
      <div className="pb-20  pt-40">
        {cartProduct?.length == 0 ? (
          <h1>Oww! You don't have any items.</h1>
        ) : (
          <h1 className="mb-10 text-center text-2xl font-bold">
            Hey User! You have {cart?.length} items in the cart.
          </h1>
        )}
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
            ...
            <div className="flex justify-between">
              ...
              <div className="">
                <p className="mb-1 text-lg font-bold">{totalPrice+150}</p>
